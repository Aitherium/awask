...
SELF = 'awask'
FAMILY = ['awarena', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awfind', 'awgit', 'awgraph',
 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awprism',
 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrise',
 'awrun', 'awscreen', 'awseal', 'awshare', 'awtoll', 'awtunnel', 'awvision',
 'awvoice', 'awwall']
PAIRS_WITH = ['awmail', 'awnest', 'awrelay']
